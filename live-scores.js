...
(function () {
  ...
  const NAME_MAP = {
    ...
    "Northern Iowa": ["northern iowa panthers", "northern iowa", "uni panthers", "uni"],
    ...
    "North Dakota St.": ["north dakota state bison", "north dakota st.", "north dakota state", "ndsu"],
    ...
    "Prairie View A&M": ["prairie view a&m panthers", "prairie view a&m", "prairie view", "pvamu"],
    "Clemson": ["clemson tigers", "clemson"],
    "Iowa": ["iowa hawkeyes", "iowa"],
    "Vanderbilt": ["vanderbilt commodores", "vanderbilt"],
    "McNeese": ["mcneese cowboys", "mcneese state cowboys", "mcneese", "mcneese state"],
    "Nebraska": ["nebraska cornhuskers", "nebraska"],
    "Troy": ["troy trojans", "troy"],
    "North Carolina": ["north carolina tar heels", "north carolina", "unc"],
    "VCU": ["vcu rams", "virginia commonwealth", "vcu"],
    "Illinois": ["illinois fighting illini", "illinois"],
    "Penn": ["penn quakers", "pennsylvania quakers", "penn", "pennsylvania"],
    "Saint Mary's": ["saint mary's gaels", "saint mary's (ca)", "saint mary's", "st. mary's"],
    ...
    "LIU": ["liu sharks", "long island university", "liu"],
    ...
    "Queens": ["queens royals", "queens university", "queens"],
    // MIDWEST
    "Michigan": ["michigan wolverines", "michigan"],
    "Howard": ["howard bison", "howard"],
    "Georgia": ["georgia bulldogs", "georgia"],
    "Saint Louis": ["saint louis billikens", "saint louis", "st. louis"],
    ...
    "Miami (OH)": ["miami (oh) redhawks", "miami (oh)", "miami ohio"],
    "Virginia": ["virginia cavaliers", "virginia"],
    "Wright State": ["wright state raiders", "wright state", "wright st."],
